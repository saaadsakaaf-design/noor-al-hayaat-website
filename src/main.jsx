...
function Footer({go}){
  ...
  <img src={"/assets/noor-al-hayaat-logo-footer.png"} alt="Noor Al Hayaat"/>
  <p className="footerStandard">Engineered in absolute compliance with global pharmaceutical regulations.</p>
  <p>Manufacturing high-quality medicines that support healthier communities and stronger local pharmaceutical capacity.</p>
</div>
